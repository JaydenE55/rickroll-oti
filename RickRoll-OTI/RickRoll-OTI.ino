...
//Defines all of the notes for the song
#define NOTE_B0  31
#define NOTE_C1  33
#define NOTE_CS1 35
#define NOTE_D1  37
...
// Put yout project auth token here
char auth[] = "Blynk Auth Token";

 
// Your WiFi credentials.
// Set password to "" for open networks
// Set your Netowork Name and Password
char ssid[] = "WiFi_Name";
char pass[] = "WiFi_Pass";
...
for (int thisNote = 0; thisNote < notes * 2; thisNote = thisNote + 2) {
    ...
    // change the 0.9 to however long you want the song to play, 1.0 being
    // the whole song, 0.5 being half the song, etc.
...
BLYNK_WRITE(V1) {
 ...
 if(pinValue == 1) {
    rickroll();
    Serial.println("Digital Button Activated");
    delay(1000);
